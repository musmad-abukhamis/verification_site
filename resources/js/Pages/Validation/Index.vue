...
const fetchTransactions = () => {
    router.get(route('validation.index'), {
        search: search.value,
...
const submitNin = async () => {
    ...
    router.post(route('validation.store'), {
        nin: nin.value,
    }, {
        onSuccess: () => {
            nin.value = '';
...
const checkStatus = async (transaction) => {
    ...
    router.post(route('validation.check', transaction.id), {}, {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
...
const canCheckStatus = (transaction) => {
    ...
    return status !== 'completed' && status !== 'validated' && status !== 'rejected';
};
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-lg shadow p-6">
                ...
                <p class="text-center text-gray-500 dark:text-gray-400 mb-4 text-sm">
                    Validate your National Identification Number (NIN) securely and efficiently.
                </p>
